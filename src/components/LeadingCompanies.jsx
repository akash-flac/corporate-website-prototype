    ...
    <div className="">
      <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 p-2 max-w-full mx-10 md:mx-20 md:my-8">
        <div className="md:px-6 col-span-1">
          ...
          <h1 className="row-span-1 text-2xl md:text-3xl/relaxed lg:text-4xl/relaxed md:pb-3 font-semibold text-[#330073]">
          ...
          <a href="" className="">
            <h1 className="row-span-1 text-[#330073] font-semibold pt-5">
